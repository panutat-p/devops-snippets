...
services:
  kafka0:
    ...
    environment:
      ...
      KAFKA_CFG_LISTENERS: PLAINTEXT://kafka0:9092,CONTROLLER://kafka0:9093
...
services:
  kafka0:
    ...
    environment:
      ...
      KAFKA_CFG_ADVERTISED_LISTENERS: PLAINTEXT://kafka0:29092,PLAINTEXT_HOST://localhost:9092
      KAFKA_CFG_LISTENERS: PLAINTEXT://kafka0:29092,CONTROLLER://kafka0:29093,PLAINTEXT_HOST://0.0.0.0:9092
